...
class _FakeLibraryRepository:
    ...
    def list_playlists(self, _filters):
        return list(self._playlists.values())

    def add_playlist_track(self, **kwargs):
        raise NotImplementedError
    ...
    def remove_library_item(self, **kwargs):
        raise NotImplementedError

    def list_library_items(self, **kwargs):
        raise NotImplementedError

    def item_exists(self, **kwargs):
        raise NotImplementedError
